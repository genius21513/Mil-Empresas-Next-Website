                        ...
                        <div className="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                            <div className="card-grid-2-image-left">
                                ...
                                <div className="image-box">
                                    <img src="/assets/imgs/brands/brand-6.png" alt="milempresas.es" />
                                </div>
                    ...
                    <SwiperSlide>
                        <div className="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                            <div className="card-grid-2-image-left">
                                <span className="flash" />
                                <div className="image-box">
                                    <img src="/assets/imgs/brands/brand-4.png" alt="milempresas.es" />
                                </div>
                                <div className="right-info">
                                    <Link href="/company-details">
                    ...
                    <SwiperSlide>
                        <div className="card-grid-2 hover-up wow animate__animated animate__fadeIn">
                            <div className="card-grid-2-image-left">
                                <span className="flash" />
                                <div className="image-box">
                                    <img src="/assets/imgs/brands/brand-8.png" alt="milempresas.es" />
                                </div>
                                <div className="right-info">
                                    <Link href="/company-details">
